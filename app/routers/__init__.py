...
__all__ = ["auth_router", "plans_router", "nutrition_router", "recipes_router", "runs_router", "adaptive_router", "performance_router", "analytics_router", "analytics_page_router", "strava_router", "triathlon_router"]
