...
Pure VDOT math lives in ``vdot_math``; this module holds the DB-facing
``RacePredictorService`` facade. Only the class is part of the public surface.
"""
