"""Strength training data: focus rotations, phase modifiers, exercise templates.

Pure data extracted from ``strength_plan`` so the logic module stays small.
No DB, no I/O — all templates are hardcoded for testability.
"""
