...
from app.core.training.workouts.key_workout_data_long.backyard import BACKYARD_LONG
from app.core.training.workouts.key_workout_data_long.road import ROAD_LONG
from app.core.training.workouts.key_workout_data_long.trail import TRAIL_LONG
