...
class TriathlonPDFGenerator(PDFBase):
    ...
    def generate_pdf(self, plan: TriathlonPlan) -> str:
        ...
        cache_key = self._cache_key_from_hash("tri_", plan.id, plan.plan_data)
        ...
        def build(doc, story):
            ...
            self._build_footer(story, "Generated by RunCoach · Triathlon Training Plan")

        return self._generate_with_cache(
            cache_key, f"triathlon_{plan.id}.pdf", build
        )
