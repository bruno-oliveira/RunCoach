...
def rebuild_long_run(workout: Dict[str, Any],
                     new_distance: float,
...
def set_distance(workout: Dict[str, Any], new_distance: float,
...
def scale_down(workouts: List[Dict[str, Any]],
               total_km: float,
...
def fill_shortfall(workouts: List[Dict[str, Any]], total_km: float,
