...
const AnalyticsDashboard = {
    ...
    _groupEvolutionByWeek(runs) {
        ...
        return Object.keys(buckets).sort().map(key => {
            ...
            const effRuns  = group.filter(r => r.avg_pace_min_km > 0 && r.avg_heart_rate > 0);
            // Aerobic Efficiency: speed (m/min) / heart rate × 100
    ...
    renderEvolutionStats(evoRuns, weeks) {
    ...
    _evolutionTrendBadge(values, badgeId, annotationId, lowerIsBetter) {
