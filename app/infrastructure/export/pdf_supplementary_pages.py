...
class SupplementaryPagesMixin:
    ...
    def _add_injury_prevention(self, story: List):
        story.append(
            Paragraph("🏥 Complete Injury Prevention Guide", self.section_style)
        )

        story.append(
            Paragraph("🔥 Warm-up Protocol (10-15 minutes)", self.normal_style)
        )
        for step in [
        ...
        story.append(
            Paragraph("❄️ Cool-down Protocol (10-15 minutes)", self.normal_style)
        )
        for step in [
        ...
        story.append(
            Paragraph(
                "💪 Essential Strength Training (2-3x per week)", self.normal_style
            )
        )
        for exercise in [
